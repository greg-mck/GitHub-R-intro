...
First, create a new directory in your project called 'data/' where you
...
```{r}
elevDF <- extract(x = elevation_crop, y = poudre_points_prj)

#elevDF
newDF <- mutate(poudre_points_prj, elevDF,)
ggplot(data = newDF) + 
